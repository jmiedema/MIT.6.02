...
def fitData(fileName):
    ...
    # squared difference error terms 
    r_squared = round(rSquare(yVals, estYVals),2)
...
def fitData2(fileName):
    ...
    a,b = pylab.polyfit(xVals, yVals, 1)
    estYVals = a*extX + b
    pylab.plot(extX, estYVals, 'r', label = 'Linear fit')
    a,b,c,d = pylab.polyfit(xVals, yVals, 3)
...
def fitData3(fileName):
    ...
    estYVals = a*xVals + b
    k = 1/a
    r_squared = str(round(rSquare(yVals, estYVals), 2))
